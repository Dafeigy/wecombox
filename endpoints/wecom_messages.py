...
class WeComMessageEndpoint(Endpoint):
    ...
    def _invoke(self, r: Request, values: Mapping, settings: Mapping) -> Response:
        ...
        chatflow_key = settings.get("chatflow_key")
        ...
        try:
            ...
            headers = {
                "Authorization": f"Bearer {chatflow_key}",
                "Content-Type": "application/json"
            }
            req = requests.post(base_url, headers=headers, data=json.dumps(api_payload))
